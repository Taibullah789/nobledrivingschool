          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm mt-8" style={{marginTop:'500px'}}>
              ...
              <p className="text-gray-700 leading-relaxed text-base mb-6">
                PRIVATE 1 ON 1 DRIVING SESSION give confidence to all new drivers who getting prepared for road test, before road test assess yourself after your last driving session.
              </p>
